...
let ride1PowerOn = document.querySelector ("#ride-1-power")
let ride2PowerOn = document.querySelector ("#ride-2-power")
let ride3PowerOn = document.querySelector ("#ride-3-power")
let ride4PowerOn = document.querySelector ("#ride-4-power")
